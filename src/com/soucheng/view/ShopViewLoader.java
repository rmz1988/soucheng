...
public class ShopViewLoader extends ViewLoader {
	...
	private void initButton() {
		...
		shopBtn1.setNormalColor(context.getResources().getColor(R.color.light_gray));
		...
		shopBtn2.setNormalColor(context.getResources().getColor(R.color.light_gray));
		...
		shopBtn3.setNormalColor(context.getResources().getColor(R.color.light_gray));
		...
		shopBtn4.setNormalColor(context.getResources().getColor(R.color.light_gray));
		...
		shopBtn5.setNormalColor(context.getResources().getColor(R.color.light_gray));
		...
		shopBtn6.setNormalColor(context.getResources().getColor(R.color.light_gray));
